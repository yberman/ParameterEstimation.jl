...
%inputs.PEsol.global_theta_y0_guess=[100. 100.];% nominal as initial guess to check consistency of data
inputs.PEsol.global_theta_max=1.*ones(1,3);
inputs.PEsol.global_theta_min=0.0001.*ones(1,3);
%inputs.PEsol.global_theta_guess=[0.02 0.03 0.05];% nominal as initial guess to check consistency of data
%=============================================================
