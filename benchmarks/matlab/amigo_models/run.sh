...
mfiles=(crauste.m crauste_JRB2.m daisy_mamil3.m FHN.m FHN_JRB2.m LotkaVolterra.m LotkaVolterra_JRB.m simple.m daisy_ex3_local.m daisy_mamil4_local.m HIV.m HIV_JRB.m HIV_JRB_ub10.m)
mkdir -p outputs
